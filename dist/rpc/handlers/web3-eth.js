...
async function _default(request, proxy, wrapper) {
  ...
  return METHOD_WHITELIST.has(method) ? Promise.resolve(web3.eth[method](...params)) : Promise.reject(new Error("Given web3.eth method (".concat(method, ") is not whitelisted")));
}
